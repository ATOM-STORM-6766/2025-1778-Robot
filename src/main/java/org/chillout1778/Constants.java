...
public class Constants {
    ...
    public static class Field {
        ...
        // Complex pose calculations would need to be implemented in static initialization blocks
        ...
        public static final double ALREADY_SCORED_BADNESS = 0.5 + Units.inchesToMeters(12.9375) * ALIGN_TRANSLATION_WEIGHT * (1 - 2*0.3);
